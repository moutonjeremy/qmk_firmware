...
[MY] = LAYOUT_extradox_pretty(
  ...
  KC_GRV,    KC_1,         KC_2,          KC_3,    KC_4,    KC_5,    KC_NO,               KC_QUOT,    KC_6,    KC_7,    KC_8,    KC_9,     KC_0,           KC_BSLS,
  ...
  KC_LSFT,   KC_Z,         KC_X,          KC_C,    KC_V,    KC_B,    KC_ENT,               KC_ENT,      KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_UP,          KC_SLSH,
  KC_HOME,   KC_END,       KC_LCTL,       KC_LALT, KC_LGUI,                                                    KC_MINS, KC_EQL,  KC_LEFT,  KC_DOWN,        KC_RGHT,
                                                            KC_NO, KC_NO,              KC_NO, KC_DEL,
                                                                    KC_NO,              KC_PGUP,
                                                    KC_SPC, KC_ENT,  KC_NO,              KC_PGDN, KC_ENT, KC_SPC
),
